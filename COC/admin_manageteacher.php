...
<div id="information" class="spacer reserve-info ">
    <div class="container">
            <div class="row">
            <div class="col-sm-12">
            <div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="height:90px">
          ...
          <div style="margin-left:200px">
            <div id="manageteacher" class="w3-container city" style="display:none">
                    <?php
                            ...
                            if (!isset($smtUpdate)) {
                                $sql='SELECT teacher_ID,teacher_name,teacher_detail,Teacher_Picture  FROM teacher';
                                    ...
                                    <form action="admin_addteacher.php" name="frmAdd" method="post" enctype="multipart/form-data">
                                        <div class="login-form">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="image" id="imageteacher">
                                                    </div>
