    ...
    <div class="container">
        <div class="row">
            ...
            <?php
											...
											if (!isset($smtUpdate)) {
													$sql = 'select * from course where Course_ID ='.$_POST['idforupdate'].'';
                                                    ...
                                                    echo '<div class="form-group">';
                                                    echo '<label for="Price" class="col-sm-4 col-form-label">รายละเอียด</label>';
                                                    echo '<input type="text" class="form-control login-field" name="dc" value="'.$row['Detail_Course'].'" />  ';
                                                    echo '</div>';
                                                    ...
                                                    echo '<input type="textarea" class="form-control login-field"  name="cb" value="'.$row['Course_Benfit'].'" />';  
                                                    echo '</div>';

                                                    echo '<div class="form-group">';
                                                    echo '<label for="Detail" class="col-sm-4 col-form-label">เนื้อหาคอร์ส</label>';
                                                    echo '<input type="textarea" class="form-control login-field"  name="cc" value="'.$row['Content_Course'].'" /> '; 
                                                    echo '</div>';
